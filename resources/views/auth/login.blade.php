...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-offset-4 col-md-4">
            <br/>
            <p style="text-align: center;">Copyright &copy;<script>document.write(new Date().getFullYear());</script> | All rights reserved <br> | Education Air Hub Nepal Pvt.Ltd. | <br><a href="#" target="_blank"> | NABIN | </a></p>
        </div>
    </div>
</div>
</body>
